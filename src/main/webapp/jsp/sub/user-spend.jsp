...
<script type="text/javascript">
	...
	function query(){
		...
		$("#datagrid").datagrid("options").url="/dbs/web/cashspend.do?userCode="+userCode;
...
<body>
	<table class="easyui-datagrid" id='datagrid' url="/dbs/web/cashspend.do"
       ...
       <thead>
           <tr>
               ...
               <th data-options="field:'amount'" width="80">支出金额</th>
               <th data-options="field:'summary'" width="80">说明</th>
               <th data-options="field:'createTime'" width="70" formatter="timefrt">支出时间</th>
