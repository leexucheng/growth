...
<div class="container" id="container" style="text-align:center;">
  ...
  <div style="margin-top:0rem;text-align:center;position:relative;">
        <%--<img src="/dbs/jsp/drawable-tvdpi/hongbao.png" style="width: 4.5rem;height: 4.6rem;position: absolute;top: 25%;left:50%;margin-left:-2.25rem;" />--%>
   <img src="/dbs/jsp/drawable-tvdpi/fuben4.png" style="width: 21.5rem;height: 25rem" />
  </div> 
  <div class="form" id="form" style="padding:2% 8%;position:relative; ">
  ...
  <div>
   ...
   <a href="http://www.cpijiang.com/app/cpj.apk" style="color: #ffcc33;display: block;text-decoration: none;margin-top:-1%">下载安卓版手机APP</a>
  </div> 
 </div> 
