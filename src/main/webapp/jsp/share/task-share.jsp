...
%>
    ...
    <div class="container"id="container" style="text-align:center;">
       ...
       <%--<img src="/dbs/jsp/drawable-tvdpi/qiuzhu.png" style="width: 20rem;height: 3rem">--%>
        ...
        <div class="img0" style="height:14rem;line-height:2rem;background:white;width:22rem;margin:2rem
        auto;border-radius:24px;">

        <div style="padding:1rem 2rem;">

        <div style="height:2rem;">
        <span class="word" style="font-size:1.2rem;">${requestScope.inforType=="WD"?"问答:":requestScope.inforType=="JJ"?"救急:":"咨询:"}${requestScope.title}</span>


        </div>

        <div style="width:20rem;padding-top:4rem;padding-left:1.5rem;float:left">

        <div style="float:left;"> <span><img src="/dbs/jsp/drawable-tvdpi/hongbao.png" style="width: 4rem;height:
        4rem"/></span> </div>


        <div class="dashang" style="padding:0.2rem 0.5rem;padding-bottom:-0.1rem;font-size:1.5rem;float:left;">
        ${requestScope.reward}</div>
        
        <c:if test="${requestScope.expireTime!=null}">
        	<div class="guoqi" style="padding-top:-1rem;padding-left:0.5rem;font-size:1.2rem;float:left;display:inline-block;">
      		${requestScope.expireTime}
      		</div></c:if>
        ...
        <div style="height:3.5rem;line-height:3.5rem;clear:both;margin:0 auto;text-align:center;">

  <img src="/dbs/jsp/drawable-tvdpi/huida.png" style="width: 20rem;height: 1.5rem"/>
        ...
        #333333;opacity:.8;height:2.4rem;line-height:2.4rem;position:relative;">
        <div class="item1" style="text-align:left;margin-left:1rem">
        <span> <img src="/dbs/jsp/drawable-tvdpi/pswd.png" style="height: 1.5rem;margin-bottom:-0.4rem"> </span>
        <input type="password" id="password" placeholder="请输入您的密码" style="border: none;font-size:1.1rem;opacity:
        .8;background-color:transparent;" />
        ...
        <div class="item" style="border-bottom:1px solid #333333;opacity:
        .8;height:2.6rem;line-height:2.4rem;position:relative;">
        <div class="item1" style="text-align:left;margin-left:1rem">
        <label>
    ...
    <br/>
    <button style="margin:0 20%;width:60%;height:2rem;border-radius: 1rem;background-color: #fff;border:
    none;font-size:1.2rem;color: #028ac8;display:block;" onclick="doReg()">注册</button>
    </div>
